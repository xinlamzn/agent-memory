...
function convertFile(filename) {
  ...
  try {
    ...
    const fullHtml = wrapInTemplate(html, filename);
 ...
 */
function wrapInTemplate(content, sourceFile) {
...
function buildAll() {
  ...
  console.log(`Open ${path.join(CONFIG.outDir, 'index.html')} in your browser.`);
}
